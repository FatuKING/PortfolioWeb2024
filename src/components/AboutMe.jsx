...
export function AboutMe () {
  return (
    <>
      <section className='flex flex-col-reverse gap-5 justify-center items-center w-4/5 md:flex-row xl:w-3/4'>
        <article className='flex flex-col'>
          ...
          <p className='inline-block pt-3 md:w-4/5 xl:w-2/3 lg:text-lg'>
