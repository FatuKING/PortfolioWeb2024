  ...
  return (
    <>
      <section className='flex flex-col md:flex-row gap-2'>
        <article className='md:w-1/2 h-44 lg:h-40 bg-gray-800 border border-gray-600 hover:border-gray-400 p-3 pt-4 pb-4 mt-5 rounded-md relative shadow shadow-gray-600 hover:shadow-gray-400'>
